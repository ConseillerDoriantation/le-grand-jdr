...
async function savePlayerPresent(id) {
  const data = {
    ...
    niveau:parseInt(document.getElementById('pp-niveau')?.value)||1,
  ...
  closeModal(); showNotif('Joueur enregistré !','success'); PAGES.players();
}
...
async function deletePlayerPresent(id) {
  ...
  await deleteFromCol('players',id); showNotif('Supprimé.','success'); PAGES.players();
}

// ══════════════════════════════════════════════
// TUTORIAL
// ══════════════════════════════════════════════
function showTutSection(idx, el) {
